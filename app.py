...
st.set_page_config(page_title="ICultivate Dashboard", layout="wide")
...
if menu == "🏠 Accueil":
    st.title("🌾 ICultivate - Optimisation et Prédiction Agricole")
...
st.write("\n---")
st.write("📌 **Projet AgriTech - 2025** | Développé avec ❤️ par ICultivate")
